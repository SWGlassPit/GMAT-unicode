//$Id: PropagatorException.hpp 9513 2011-04-30 21:23:06Z djcinsb $
//------------------------------------------------------------------------------
//                            PropagatorException
//------------------------------------------------------------------------------
...
{
   public:
      PropagatorException(const wxString& message = wxT("Unspecified"),
   ...
   //         Gmat::MessageType mt = Gmat::ERROR_);
         ...
         : BaseException(wxT("Propagator Exception: "), message, mt) {};
};
