...
/*          *wxT("ANOMALOUS OXYGEN") NUMBER DENSITY, OUTPUT D(9) */
...
/*           group these species under the term wxT("anomalous oxygen,") since */
...
/*           densitywxT(" by including contributions from ")anomalous oxygen." */
/*           See wxT("NOTES ON OUTPUT VARIABLES") below on D(6). */
