...
//------------------------------------------------------------------------------
//  NRLMsise00Atmosphere(const wxString &name = wxT(""))
//------------------------------------------------------------------------------
/**
 *  Constructor.
 */
//------------------------------------------------------------------------------
NRLMsise00Atmosphere::NRLMsise00Atmosphere(const wxString &name) :
   AtmosphereModel     (wxT("NRLMSISE00"), name),
   fileData            (false),
   fluxfilename        (wxT(""))
{
   #ifdef DEBUG_NRLMSISE00_ATMOSPHERE
 ...
 *
 * @param <m> the NRLMsise00Atmosphere object whose data to assign to wxT("this")
 *            AtmosphereModel.
 *
 * @return wxT("this") NRLMsise00Atmosphere with data of input NRLMsise00Atmosphere st.
 */
//------------------------------------------------------------------------------
...
//         wxT("Central body pointer not set in NRLMSISE00 model."));
...
//      alt = CalculateGeodetics(&pos[i6], epoch, true);
      ...
      #ifdef DEBUG_NRLMSISE00_ATMOSPHERE
         MessageInterface::ShowMessage(
            wxT("Calculating NRLMSISE00 Density from parameters:\n   ")
            wxT("yd = %d\n   sod = %.12lf\n   alt = %.12lf\n   lat = %.12lf\n   ")
            wxT("lon = %.12lf\n   lst = %.12lf\n   f107a = %.12lf\n   ")
