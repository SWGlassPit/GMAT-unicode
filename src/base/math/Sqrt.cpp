//$Id: Sqrt.cpp 9513 2011-04-30 21:23:06Z djcinsb $
//------------------------------------------------------------------------------
//                                  Sqrt
//------------------------------------------------------------------------------
 ...
 */
//------------------------------------------------------------------------------
Sqrt::Sqrt(const wxString &nomme)
   : MathFunction(wxT("Sqrt"), nomme)
{
}
...
{
   if (leftNode == NULL)
      throw MathException(wxT("Sqrt() - Missing input arguments.\n"));
