//$Id: RadToDeg.cpp 9513 2011-04-30 21:23:06Z djcinsb $
//------------------------------------------------------------------------------
//                                  RadToDeg
//------------------------------------------------------------------------------
 ...
 */
//------------------------------------------------------------------------------
RadToDeg::RadToDeg(const wxString &nomme)
   : MathFunction(wxT("RadToDeg"), nomme)
{
}
...
{
   throw MathException(wxT("MatrixEvaluate()::RadToDeg returns a real value.\n"));    
}
