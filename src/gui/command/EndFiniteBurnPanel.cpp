//$Id: EndFiniteBurnPanel.cpp 9514 2011-04-30 21:44:00Z djcinsb $
//------------------------------------------------------------------------------
//                              EndFiniteBurnPanel
//------------------------------------------------------------------------------
...
void EndFiniteBurnPanel::Create()
{
   ...
   MessageInterface::ShowMessage
      (wxT("EndFiniteBurnPanel::Create() Entered. command=%s\n"),
   ...
   #ifdef DEBUG_ENDFBPANEL_CREATE
   MessageInterface::ShowMessage
      (wxT("EndFiniteBurnPanel::Create() Calling theGuiManager->")
   ...
   #ifdef DEBUG_ENDFBPANEL_CREATE
   MessageInterface::ShowMessage(wxT("EndFiniteBurnPanel::Create() Exiting\n"));
   #endif
}
...
void EndFiniteBurnPanel::LoadData()
{
   ...
   try
   {
      ...
      MessageInterface::ShowMessage
         (wxT("EndFiniteBurnPanel::LoadData() burnName=<%s>\n"), burnName.c_str());
      #endif
...
void EndFiniteBurnPanel::SaveData()
{
   ...
   MessageInterface::ShowMessage(wxT("EndFiniteBurnPanel::SaveData() entered\n"));
   #endif
   ...
   #ifdef DEBUG_ENDFBPANEL_SAVE
   MessageInterface::ShowMessage(wxT("EndFiniteBurnPanel::SaveData() exiting\n"));
   #endif
}
